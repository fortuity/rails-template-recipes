...
|_. File                    |_. Purpose                                 |_. Dependencies     |_. Authors |
...
| add_user_name.rb          | aads name to User, generates Devise views | User model, Devise | dkehoe |
...
| cucumber_extras.rb        |  |  |  |
| devise_extras.rb          | Replacement for the RailsWizard standard Devise recipe | none | dkehoe |
...
| sample_readme.textile     | Placeholder text for a README file (textile markup)A | none | dkehoe |
