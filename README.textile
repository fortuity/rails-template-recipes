...
h4. Custom Application Templates
...
Here's an example of an application template that was assembled from these recipes:
...
"Rails Wizard":http://railswizard.org/ is a website you can visit to create application templates that are used to generate a Rails 3 web application. Rails Wizard might not have all the ingredients or customizations you want for your Rails app. This is a collection of extra recipes that you can add to the Rails Wizard mix.
...
|_. File |_. Name |_. Purpose |_. Authors |
| action_mailer.rb          | ActionMailer         | Changes ActionMailer defaults                    | dkehoe
